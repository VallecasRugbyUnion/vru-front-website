  ...
  return (
    <Card variant="gradient" color="white">
      <CardBody className="text-center">
        ...
        />
        <Typography variant="h1" color="blue-gray" className="mb-2 mt-10 flex justify-center">
          <Typography as="span" variant="h5" color="blue-gray" className="-translate-y-1 self-end">
            {price[1]}
            {price[0]}
          </Typography>
        </Typography>
        ...
        <Typography className="mb-2 mt-10 flex justify-center" variant="h5" color="blue-gray">
          {subTitle}
        </Typography>
        <ul className="my-6 flex flex-col gap-3 pt-6">
          {options.map((option, key) => (
            <li key={key} className="flex items-center gap-2 text-gray-700">
              ...
              <Typography className="font-normal text-inherit">{option}</Typography>
            </li>
          ))}
        </ul>
      </CardBody>

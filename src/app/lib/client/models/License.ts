...
import {
    SimpleSeasonFromJSON,
    SimpleSeasonFromJSONTyped,
    SimpleSeasonToJSON,
} from './SimpleSeason';
...
export function LicenseFromJSONTyped(json: any, ignoreDiscriminator: boolean): License {
    ...
    return {
        ...
        'processingDate': !exists(json, 'processing_date') ? undefined : (json['processing_date'] === null ? null : new Date(json['processing_date'])),
        'annulationDate': !exists(json, 'annulation_date') ? undefined : (json['annulation_date'] === null ? null : new Date(json['annulation_date'])),
    };
}
...
export function LicenseToJSON(value?: License | null): any {
    ...
    return {
        ...
        'processing_date': value.processingDate === undefined ? undefined : (value.processingDate === null ? null : value.processingDate.toISOString().substring(0,10)),
        'annulation_date': value.annulationDate === undefined ? undefined : (value.annulationDate === null ? null : value.annulationDate.toISOString().substring(0,10)),
    };
}

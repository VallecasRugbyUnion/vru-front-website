  ...
  return [
    {
      ...
      description:
        'Nuestras campeonas de segunda división ahora jugarán en primera, con un amplio equipo federado compitiendo también en la liga de desarrollo femenina.',
      buttons: [
        {
  ...
  return [
    {
      ...
      description:
        'Nuestro senior masculino cuenta con más de 70 jugadores federados y compiten en la Tercera y Segunda División regional con 2 equipos.',
      muted: false,
      loop: false,
      buttons: [
        {
    ...
    pricingCards: [
      {
        ...
        price: ['€', '225'],
        priceSubTitle: 'Temporada Completa',
        subTitle: 'El pago se puede realizar en tres cuotas: la primera de 85€ y las dos siguientes de 70€ cada una.',
        options: [],
      },
    ],
  };
...
function getMascGeneralInfo() {
  return {
    ...
    title: 'Entrenamientos',
    subTitle:
      '¡Únete a nuestro equipo senior Masculino! Entrenamos dos veces a la semana en el Campo de Rugby Los Arbolitos.',
